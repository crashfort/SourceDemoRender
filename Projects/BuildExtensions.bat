...
msbuild "VelocityTextExtension\VelocityTextExtension.sln" /m:4 /t:Rebuild /clp:ErrorsOnly;WarningsOnly
msbuild "MultiProcessExtension\MultiProcessExtension.sln" /m:4 /t:Rebuild /clp:ErrorsOnly;WarningsOnly
